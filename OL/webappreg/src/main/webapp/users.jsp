<%@page import="hu.schonhercz.web.Account"%>
		...
		<tbody>
			<%
				if (session.getAttribute("userList") != null) {
					ArrayList<Account> itemsArray = (ArrayList<Account>) session.getAttribute("userList");
					for (int i=0; i < itemsArray.size(); i++) {
						...
						<tr>
							...
							<td>
								<% out.println(itemsArray.get(i).getBirthPlace()); %>
							</td>
							<td>
					...
					out.println("Nincs regisztrált felhasználó!");
				}
			%>
		</tbody>
		<tfoot>
