		...
		<div>
			<form action="RegistrationServlet" method="post" class="cmxform">
				<fieldset>
					...
					<p> <label for="pass">Password:<span>Required minimum 4 characters</span></label><input type="text" name="pass" required minlength="4"></p>
		...
		<div>
			...
			<form action="LoginServlet" method="post" class="cmxform">
				<fieldset>
					...
					<p><label for="pass">Password:</label> <input type="text" name="pass" required></p>
