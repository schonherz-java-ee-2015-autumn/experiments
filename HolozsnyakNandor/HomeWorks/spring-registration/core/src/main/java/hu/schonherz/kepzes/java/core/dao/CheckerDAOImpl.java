...
public class CheckerDAOImpl extends JdbcDaoSupport implements CheckerDAO{
	...
	public boolean checkUserByUsername(String userName) {
		...
		List<UserDTO> queriedUser = getJdbcTemplate().query(sql, new Object[]{userName},
	...
	public boolean checkUserByEmail(String eMail) {
		...
		List<UserDTO> queriedUser = getJdbcTemplate().query(sql, new Object[]{eMail},
				new RowMapper<UserDTO>() {
					@Override
					public UserDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
						UserDTO qUser = new UserDTO();
